...
<section class="popup popup--login">
  <form class="login-div" action ="/signup" method='POST'>
    {{ csrf_field() }} 

    <div class="logo"></div>
    <div class="title">Your registration</div>
    <div class="sub-title">BETA</div>
    <div class="fields">
      <div class="username"><input type="text" class="user-input" placeholder="username"  name="name"/></div>
      <div class="username"><input type="email" class="user-input" placeholder="email"  name="email"/></div>
